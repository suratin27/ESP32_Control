/*
    ModbusSlaveSerial.h - Header for ModbusSlaveSerial Library
    Copyright (C) 2014 Andr� Sarmento Barbosa
*/
#include <Arduino.h>
#include "ModbusSlave.h"

#ifndef MODBUSSLAVESERIAL_H
#define MODBUSSLAVESERIAL_H
...
class ModbusSlaveSerial : public ModbusSlave {
 ...
 public:
  ...
  bool send(byte* frame);
   ...
   bool config(HardwareSerial* port, long baud,uint8_t _RX = 22 ,uint8_t _TX = 23);
  #endif
